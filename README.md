...
|---|:---:|---|
| 📌 Persistence | 10 | Run key, scheduled task, service, Azure AD admin role |
| 🚪 Initial Access | 8 | RDP เปิดออกเน็ต, SQLi, path traversal, **Log4Shell** |
